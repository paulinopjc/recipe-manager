  ...
  <PublicLayout>
    ...
    <div class="bg-gray-800 text-white">
      <div class="max-w-7xl mx-auto px-[15px] py-14">
        <nav class="flex flex-wrap items-center gap-1 text-sm text-white/70 mb-4">
          ...
          <span>/</span>
          <span class="text-white font-medium">Most Viewed</span>
        </nav>
        <h1 class="text-3xl font-bold">Most Viewed</h1>
        <p class="mt-2 text-white/80">The recipes our readers keep coming back to.</p>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-[15px] py-10">
      ...
      <div class="flex flex-wrap gap-3 mb-8">
        <input v-model="q" type="search" placeholder="Search most viewed recipes…"
